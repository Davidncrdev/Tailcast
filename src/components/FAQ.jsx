...
const FAQData = [
  {
    ...
    answer:
      "Sí, puedes actualizar o degradar tu plan en cualquier momento. Simplemente navega a la configuración de tu cuenta en el panel de control y elige el plan deseado. Los cambios se reflejarán de inmediato y cualquier ajuste en el precio se aplicará en tu próximo ciclo de facturación. Nuestro equipo de soporte está más que feliz de ofrecerte orientación y recomendaciones.",
  },
  {
    question: "¿Cómo reclamar la oferta de descuento del 25%?",
    answer:
      "Para reclamar tu descuento del 25%, simplemente regístrate para obtener una cuenta e ingresa el código promocional al momento de pagar. El descuento se aplicará automáticamente a tu compra.",
  },
  {
  ...
  {
    question: "¿Cómo obtener soporte para el producto?",
    answer:
      "Nuestro equipo de soporte está aquí para ayudarte. Puedes contactarnos a través del formulario de contacto en nuestro sitio web, enviar un correo electrónico o interactuar con nosotros a través del chat en vivo. Estaremos encantados de asistirte con cualquier pregunta o inquietud que puedas tener.",
  },
];
