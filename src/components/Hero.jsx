      ...
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-16 md:pt-16 lg:pt-20 text-center">
        ...
        >
          <div className="text-5xl sm:text-6xl lg:text-6xl xl:text-6xl font-bold tracking-wide  text-primaryText  px-8 sm:px-8 md:px-20 lg:px-4">
            ...
            <h1 className="hidden md:inline">Soluciones tecnológicas</h1>
          </div>
          <h1 className="mt-2 sm:mt-2 text-4xl sm:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-wide  text-primaryText  px-8 sm:px-20 md:px-24 lg:px-24">
          para empresas
          </h1>
        </motion.div>
        <motion.div
        ...
        >
          <h2 className="text-secondaryText text-sm lg:text-base xl:text-lg sm:text-base mt-10 px-12 sm:px-48 ">
            Analizamos las necesidades del negocio y aportamos las mejor soluciones.
          </h2>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
