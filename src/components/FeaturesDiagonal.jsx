      ...
      >
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-bgDark1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            <span className="block-subtitle">Libere la Eficiencia con la Optimización Experta de Recursos</span>
            <h2 className="mt-10 mb-8 text-4xl lg:text-5xl block-big-title">
              Acelera &amp; Y optimiza los recursos de tu empresa
            </h2>
            <p className="mb-16 text-secondaryText leading-loose">
            Nuestro servicio integral de optimización de recursos se centra en eliminar el desperdicio, agilizar los procesos y aprovechar tecnologías de vanguardia para asegurar que su negocio funcione de manera fluida y rentable.
